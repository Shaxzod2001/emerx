...
const I18N = {
  ru: {
    ...
    chat_title: '💬 Чат', chat_placeholder: 'Написать сообщение...',
    ...
    chat_invalid_length: 'Сообщение пустое или слишком длинное',
    chat_tab_group: 'Общий', chat_tab_private: 'Личные',
    chat_contacts_empty: 'Нет доступных пользователей', chat_select_contact: 'Выберите собеседника, чтобы начать переписку',
    dm_placeholder: 'Личное сообщение...', dm_not_found: 'Пользователь не найден',
  ...
  uz: {
    ...
    chat_title: '💬 Chat', chat_placeholder: 'Xabar yozing...',
    ...
    chat_invalid_length: "Xabar bo'sh yoki juda uzun",
    chat_tab_group: 'Umumiy', chat_tab_private: 'Shaxsiy',
    chat_contacts_empty: "Foydalanuvchilar yo'q", chat_select_contact: 'Suhbatni boshlash uchun foydalanuvchini tanlang',
    dm_placeholder: 'Shaxsiy xabar...', dm_not_found: 'Foydalanuvchi topilmadi',
  ...
  tj: {
    ...
    chat_title: '💬 Чат', chat_placeholder: 'Паём нависед...',
    ...
    chat_invalid_length: 'Паём холӣ ё хеле дароз аст',
    chat_tab_group: 'Умумӣ', chat_tab_private: 'Шахсӣ',
    chat_contacts_empty: 'Корбарон нест', chat_select_contact: 'Барои сар кардани сӯҳбат корбарро интихоб кунед',
    dm_placeholder: 'Паёми шахсӣ...', dm_not_found: 'Корбар ёфт нашуд',
