...
const MESSAGES = {
  ...
  avatar_invalid:      { ru: 'Неверный формат изображения или файл слишком большой', uz: 'Rasm formati noto\'g\'ri yoki fayl juda katta', tj: 'Формати расм нодуруст ё файл хеле калон аст' },
  ...
  super_admin_only:    { ru: 'Доступно только главному администратору', uz: 'Faqat super admin uchun', tj: 'Танҳо барои администратори калон' },
